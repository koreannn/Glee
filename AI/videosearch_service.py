...
class VideoSearchService:
    def __init__(self):
        ...
        # 임베딩 모델 초기화
        self.embeddings = HuggingFaceEmbeddings(model_name="jhgan/ko-sbert-nli", model_kwargs={"device": "mps"})
    ...
    def youtube_search(self, query: str, max_results: int = 1, page_token: str = None) -> Dict:
        try:
            # API 키 확인
